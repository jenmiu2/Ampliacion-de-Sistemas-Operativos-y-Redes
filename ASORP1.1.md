...
### Ejerc.
- **(VM4)** Conectarse al puerto 80 de Router con nc y comprobar el resultado en VM1. Analizar el tráficio 1 
n auda den cmando ss la ioraacenada coletar l sigiete  con aámet u rmin conuar el eoradorpco

### Ejercicio 1
Configura    renestino  e aintercambiado con wireshark, especialmente los puertos y direcciones IP origen y destino en ambas redes.

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc4OTI3NDAzMCwxNDYxNzI4OTE4LDE2Nj
