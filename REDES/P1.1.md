...
#### CMP
El protocolo CMP es el protocolo de intercambio de mensajes, los tipos que tenemos son request (type = 0) y reply (type = 8)
#### ARP
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwNDI2MjYwMjksMTA0OTY5NTYyNywtMT
