...
| VM4 | 172.16.0.1/24 (eth0)| Añadir router como encaminador por defecto |
...
| MAC Origen| MAC Destino | Protocolo | IP Origen | IP Destino | Tipo Mensaje
|--|--|--|--|--|--|
| ?? | 00:00:00:00:00:00 | ARP | 172.16.0.1 | ff:ff:ff:ff:ff:ff | Who has 172.16.0.3? Tell 172.16.0.1 |
| ?? | ?? | ARP | 172.16.0.3 | 172.16.0.1 | 172.16.0.3 is at ?? |
|  |  | CMP | 192.168.0.2 | 192.168.0.1 | Echo (ping) request |
|  |  | CMP | 192.168.0.1 | 192.168.0.2 | Echo (ping) reply |
```bash
ip neigh
...
| address | dev name  | vrf name | proxy | unused | nud
|--|--|--|--|--|--|
| 172.16.0.1| eth0 | lladdr | 08:00:27:4c:af:03 |  | STALE |
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTUzMjAwNTY3NSwtMjY2MjUzMTM3LC05Mj
IwMzAzNzUsOTc1MDEzOTY0LDgyMDU3MTgzMSwxOTg1MTk2MzA0
LDEwNDk2OTU2MjcsLTE1MTgxNTEwNzUsMTM1MjQ5OTA2NywxNz
k5NDgwMjA1LDE5NTM4NDUyNTcsMTM3NTU1NjE3XX0=
-->