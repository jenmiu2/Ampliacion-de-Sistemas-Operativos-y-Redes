...
#### ARP
EL protocol ARP **(Address Resolution Protocol)** para IPv4 permite la resolución de direcciones MAC. Se encarga la máquina que quiere solicitar una dirección 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTY0ODUxNDI5NSwxMDQ5Njk1NjI3LC0xNT
