...
En el caso de ejecutar otra vez ping al principio de la ejecución no se utiliza el protocolo ARP para averiguar de quien es la dirección MAC asociada a la dirección IP 192.168.0.1. Sólo se repite la pregunta cada tanto para comprobar
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTMxMDUwNDY0MCw4MjA1NzE4MzEsMTk4NT
