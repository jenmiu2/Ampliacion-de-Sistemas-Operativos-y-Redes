...
#### CMP
El protocolo CMP es el protocolo de intercambio de mensajes, los tipos que tenemos son request (type = 0) y reply (type = 8), el código de ambos es 0 como dicen las transparencias de clase. La primera secuencia del mensaje request es (BE) 0x0aad / (LE) 0xad0a; la primera secuencia del mensaje
#### ARP
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTk1MjkzODQwMSwxMDQ5Njk1NjI3LC0xNT
